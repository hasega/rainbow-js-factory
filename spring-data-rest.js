        ...
        return new Promise(function (resolve, reject) {
            if (entity.isEntity(data)) {//is a Entity instance
                ...
                for (var one in data) {
                    ...
                    promiseList.push(translateRelationEntity(data[one]));
                }
        ...
        function Entity(initData) {
            ...
            this._update = function () {
                ...
                for (var i = 0; i < self._modifyFileds.length; i++) {
                    ...
                    if ((links && links[key]) && ((entity.isEntity(value)) || (Array.isArray(value) && entity.isEntity(value[0])))) {//is relation entity or entity array
